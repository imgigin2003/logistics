...
export default function TestimonialsSection() {
  const testimonials = [
    ...
    },
    {
      ...
      rating: 5,
      text: "حمل بار صنعتی من بدون هیچ مشکلی انجام شد. خدمات عالی و پشتیبانی بی‌نظیر. قیمت‌ها هم بسیار منصفانه است.",
    },
    {
      name: "زهرا احمدی",
      title: "مسئول لجستیک",
        ...
        <AnimatedSection>
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              ...
              <strong> باربری نیلگون خلیج فارس </strong> چه می‌گویند.
            </p>
          </div>
        </AnimatedSection>
